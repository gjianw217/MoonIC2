...
static void phy_monitor_thread_entry(void *parameter)
{
	...
	/* PHY RESET: PG12 for MC_NET */
	#define RCC_AHB1Periph_Net_Rst	RCC_AHB1Periph_GPIOG
	#define GPIO_Pin_Net_Rst GPIO_Pin_12
	#define GPIOx_Net_Rst GPIOG
/*
	//PHY RESET: PD3  for ALIENTEK  
	#define RCC_AHB1Periph_Net_Rst	RCC_AHB1Periph_GPIOD
	#define GPIO_Pin_Net_Rst GPIO_Pin_3
	#define GPIOx_Net_Rst GPIOD
*/
...
void rt_hw_stm32_eth_init(void)
{
    /* PHY RESET: PD3 */
    {
        ...
        RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_Net_Rst, ENABLE);

        GPIO_InitStructure.GPIO_Pin = GPIO_Pin_Net_Rst;
        GPIO_Init(GPIOx_Net_Rst, &GPIO_InitStructure);

        GPIO_ResetBits(GPIOx_Net_Rst, GPIO_Pin_Net_Rst);
        rt_thread_delay(2);
        GPIO_SetBits(GPIOx_Net_Rst, GPIO_Pin_Net_Rst);
        rt_thread_delay(2);
    }
...
/*
int rt_get_mac_addr(unsigned char *mac)
{
	return rt_device_control(&(stm32_eth_device.parent), NIOCTL_GADDR, mac);
}*/
